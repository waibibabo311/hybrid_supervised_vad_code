    ...
    for root, dirs, files in os.walk(main_directory):
        for filename in files:
            ...
            if filename.endswith(file_extension):
                ...
                # 创建一个1024x1024的零矩阵
                output_array = np.zeros((1024, 1024, 3), dtype=np.uint8)
                ...
                print(file_path[:-4]+"_resize.png" + " has been written")
                with open("output_Ubnormal_4_region_resize.txt", "a") as f:
                    print(file_path[:-4]+"_resize.png" + " has been written", file=f)

with open("output_Ubnormal_4_region_resize.txt", "a") as f_2:
    print("down", file=f_2)
